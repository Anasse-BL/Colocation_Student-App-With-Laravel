            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="robertoNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="index.html"><h6>  Student_Coloco </h6></a>
                    ...
                    <div class="roberto-contact-form">
                        <form  method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="50ms">
                                    <input name="image" type="file" class="form-control mb-30" placeholder="Your image">
                                </div>

                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="50ms">
                                    <input name="password" type="password" class="form-control mb-30" placeholder="Your password">
                                </div>

                                <div class="col-12 wow fadeInUp" data-wow-delay="100ms">
                                    <textarea name="adresse" class="form-control mb-30" placeholder="Your Adresse"></textarea>
                                </div>
                                <div class="col-12 text-center wow fadeInUp" data-wow-delay="100ms">
                                    <button type="submit" class="btn roberto-btn mt-15">Send </button>
                                </div>
                            </div>
                        </form>
                    </div>
