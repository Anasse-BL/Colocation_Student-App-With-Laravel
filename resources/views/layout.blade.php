...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title -->
        <title>Colocation_Student</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="top-header-content">
                                ...
                                <a href="#"><i class="icon_mail"></i> <span>baalianasse@gmail.com</span></a>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <nav class="classy-navbar justify-content-between" id="robertoNav">
                            ...
                            <div class="book-now-btn ml-3 ml-lg-5">
                              <h6>  Student_Coloco </h6>
                            </div>
                            <!--
                            <a class="nav-brand" href="index.html"><p><img src="images/logo9.png" ></p></a>
                            -->
                            ...
                            <div class="classy-menu">
                                ...
                                <div class="classynav">
                                    ...
                                    <!-- Book Now -->
                                    <div class="book-now-btn ml-3 ml-lg-5">
                                        <a href="{{route('inscription.index')}}">Inscription <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <!-- Nav End -->
                            </div>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInLeft" data-delay="200ms">Colocation &amp; Resort</h6>
                                    <h2 data-animation="fadeInLeft" data-delay="500ms">Welcome To Our App</h2>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInUp" data-delay="200ms">Colocation &amp; Resort</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms">Welcome To Our App</h2>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInDown" data-delay="200ms">Colocation &amp; Resort</h6>
                                    <h2 data-animation="fadeInDown" data-delay="500ms">Welcome To Our App</h2>
