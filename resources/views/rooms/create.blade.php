                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li><a href="{{route('room.index')}}"> Add a Room</a></li>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="room-thumbnail">
                            <img src="/storage/cover_images/{{$room->image}}" alt="">
                        </div>
                        <!-- Room Content -->
                        <div class="room-content">
                        <h2>{{$room->name}}</h2>
                            <h4>{{$room->price}}DH <span>/ Mounth</span></h4>
                            <div class="room-feature">
                                <h6>Size: <span>30 ft</span></h6>
                            <h6>Capacity: <span>Max persion {{$room->capacity}}</span></h6>
                            <h6>Adresse <span>{{$room->adresse}}</span></h6>
                            <h6>Description <span>{{$room->description}}</span></h6>
                            </div>
